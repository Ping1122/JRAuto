...
class SailingOff(State):
	...
	def __init__(self):
		...
		self.transition.update({
			...
			Transitions.selectCombat : ({StateKey.sailingOffCombat, }, (461, 62, 6)),
			Transitions.selectExercise : ({StateKey.sailingOffExercise, }, (798, 62, 6)),
			Transitions.selectExpidition : ({StateKey.sailingOffExpidition, }, (1122, 62, 6)),
			Transitions.selectCampaign : ({StateKey.sailingOffCampaign, }, (1465, 62, 6)),
		})

...
class EnemyInfo(State):
	...
	def __init__(self):
		...
		self.sign.update({
			...
			Signals.stage61aNotAllSubmarine : {
				(1169, 1244) : ((51, 50, 37, 255), ),
				(1117, 997) : ((32, 34, 36, 255), ),
				(172, 439) : ((168, 169, 176, 255), (246, 246, 246, 255)),
				(428, 501) : ((185, 107, 171, 255), (227, 210, 201, 255)),
				(885, 438) : ((86, 86, 98, 255), (233, 231, 231, 255)),
				(853, 695) : ((219, 213, 181, 255), (196, 127, 169, 255)),
				(115, 917) : ((169, 163, 171, 255), (171, 172, 171, 255)),
				(428, 1003) : ((190, 89, 104, 255), (250, 238, 237, 255)),
			}
		})
